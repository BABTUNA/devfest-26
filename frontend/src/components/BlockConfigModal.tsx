      ...
      >
              ...
              <div key={input.key}>
                ...
                <p className="mt-0.5 text-[10px] text-app-soft">
                  {showVoiceDropdown
                    ...
                    : 'Leave blank to use connected upstream or entry modal value at run time.'}
                </p>
              </div>
            );
          })}
        ...
        <div className="flex gap-2 border-t border-app px-4 py-3">
          ...
          <button
            type="button"
            onClick={handleSave}
            className="flex inline-flex items-center gap-2 rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-500"
          >
